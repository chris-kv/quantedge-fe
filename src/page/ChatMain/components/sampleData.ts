...
const backTestData = {
  ...
  id: "66f7050b9c97dbd4700490c1",
  name: "Options Buying Strategy",
  parameters: {
    end_date: "2024-09-27",
  ...
  results: {
    result_file_path:
      "https://results-backtest.sgp1.digitaloceanspaces.com/66f674ea873e9bddffca9914/66f7050b9c97dbd4700490c1_1727464717.csv",
    summary: {
      AverageProfitPerLosingTrade: -267.62,
      AverageProfitPerTrade: 47.08,
      AverageProfitPerWinningTrade: 128.96,
      Expectancy: 0.18,
      LosingRatio: 20.65,
      MaximumDrawdown: -1884,
      MaximumLosingStreak: 2,
      MaximumProfitInSingleTrade: 339,
      MaximumWinningStreak: 16,
      MinimumProfitInSingleTrade: -1285.5,
      NumberOfTrades: 247,
      OverallProfit: 11628,
      ReturnOverMaximumDrawdown: 6.14,
      RewardToRiskRatio: 0.48,
      WinningRatio: 79.35,
    },
    trade_wise_results: [
      [
  ...
  run_ts: "2024-09-27T19:18:35.133000",
  status: "completed",
  strategy: {
    EntryIndicators: {
...
export { backTestData, summarySampleData };
